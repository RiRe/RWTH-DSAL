...
\pagestyle{fancy}
\fancyhf{}
\lhead{Richard Reiber, 368420\\Datenstrukturen und Algorithmen}
\rhead{\today}
\cfoot{\thepage}
\usepackage{booktabs}
%\usepackage{pgfplots}
...
Es stellt sich die Frage, wie man einen Graphen als Datenstruktur am sinnvollsten repräsentiert. Hierzu gibt es verschiedene Möglichkeiten.\\
